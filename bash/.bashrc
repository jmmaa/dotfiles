...
export CUSTOM_CARGO_BIN_DIR="$HOME/.cargo/bin"
[ -s "$CUSTOM_CARGO_BIN_DIR/tree-sitter" ] && \. "$CUSTOM_CARGO_BIN_DIR/tree-sitter"  # This loads tree-sitter
# -------------- #
...
export PATH="$CUSTOM_CARGO_BIN_DIR:$PATH"
# -------------- #
